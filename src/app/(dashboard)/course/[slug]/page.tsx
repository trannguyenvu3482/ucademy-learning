    ...
    <div className="grid lg:grid-cols-[2fr,1fr] gap-10 min-h-screen">
      <div>
        ...
        <CourseSection title="Mô tả">
          <div className="leading-normal whitespace-pre-wrap">{data.desc}</div>
        </CourseSection>
        <CourseSection title="Thông tin">
          <div className="grid grid-cols-4 gap-5 mb-10">
            ...
            <InfoBox title="Trình độ">
              {courseLevelsLabel[data.level as keyof typeof courseLevelsLabel]}
            </InfoBox>
      ...
      <div className="sticky top-6 h-max">
        <div className="bg-white rounded-lg p-5 dark:bg-grayDarker dark:text-white">
          ...
          <div className="flex items-center gap-2 mb-2">
            <strong className="text-primary text-3xl">{data.sale_price}</strong>
